      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        >
          <div class="u-container-layout u-container-layout-1">
            ...
            <div class="u-form u-login-control u-form-1">
              ...
              @csrf
                <div class="u-form-group u-form-name">
                  <label
                    for="username-a30d"
                    class="u-label u-text-grey-25 u-label-1"
                    >Username *</label
                  >
                  <input
                    type="text"
                    ...
                    id="username"
                    name="username"
                    class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-30 u-input-1"
                    required=""
                  />
                </div>
                <div class="u-form-group u-form-password">
                  <label
                    for="password-a30d"
                    class="u-label u-text-grey-25 u-label-2"
                    >Password *</label
                  >
                  <input
                    type="password"
                    ...
                    id="password"
                    name="password"
                    class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-30 u-input-2"
                    required=""
                  />
                </div>
                <div class="u-form-checkbox u-form-group">
                  ...
                  <label
                    for="checkbox-a30d"
                    class="u-field-label u-text-grey-25"
                    style="
                ...
                <div class="u-align-left u-form-group u-form-submit">
                  <a
                    href="#"
                    class="u-btn u-btn-round u-btn-submit u-button-style u-radius-30 u-btn-1"
                    >Login</a
                  >
                  <input
                    type="submit"
            ...
            <a
              href="https://nicepage.com/k/apple-website-templates"
              class="u-border-1 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-login-control u-login-create-account u-none u-text-palette-1-base u-btn-2"
              >Don't have an account?</a
            >
            <a
              href="https://nicepage.com/c/education-website-templates"
              class="u-border-1 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-palette-1-base u-btn-3"
              >Forgot password?</a
            >
          </div>
        </div>
