                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                                            ...
                                            <!-- Ellipsis icon for visual representation of more options -->
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <!-- Header for the dropdown menu (if needed) -->
                                            ...
                                            <!-- Divider for visual separation in the dropdown menu -->
                                            <div class="dropdown-divider"></div>
                                            
                                            <!-- Additional dropdown menu item -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/sign-in">Logout</a>
                </div>
            </div>
        </div>
    </div>
